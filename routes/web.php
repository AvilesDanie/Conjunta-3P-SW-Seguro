...
Route::middleware(['auth', 'verified', VerifyActiveUser::class])->group(function () {
    ...
    Route::middleware(['role:Administrador|Ventas'])->group(function () {
        ...
        Route::patch('/payments/{payment}/accept', [PaymentController::class, 'accept'])->name('payments.accept');
...
// Rutas para usuarios con rol "Pagos"
Route::middleware(['role:Pagos'])->group(function () {
